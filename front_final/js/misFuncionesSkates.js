...
function traerInformacionSkate() {
    $.ajax({
        url:"http://129.151.118.251:80/api/Skate/all",
...
function cargarDatosSkate(id) {
    $.ajax({
        dataType: 'json',
        url:"http://129.151.118.251:80/api/Skate/"+id,
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://129.151.118.251:80/api/Skate/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://129.151.118.251:80/api/Skate/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://129.151.118.251:80/api/Skate/update",
